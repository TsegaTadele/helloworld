...
export function fakeBackendFactory(
  ...
  const token =
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IlRzZWdhVGFkZWxlVGFtcmF0QGdtYWlsLmNvbSIsImFkbWluIjp0cnVlfQ.u4LZ19t3Ok9jcZczeeQh-WWYxMYNNKlQs-pIRTQW9i8';
  ...
  backend.connections.subscribe((connection: MockConnection) => {
    ...
    setTimeout(() => {
      ...
      if (
        ...
        if (
          body.email === 'TsegaTadeleTamrat@gmail.com' &&
          body.password === '1234'
        ) {
